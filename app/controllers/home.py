    ...
    try:
        ...
        for sheet, sheet_data in form_data.items():
            ...
            if Config.DESTINATION == 'redshift':
                response_texts.append(destination_redshift(csv, table_name))
            elif Config.DESTINATION == 'azuredw':
                response_texts.append(destination_azuredw(csv, table_name))
            else:
                response_texts.append(destination_local(csv, table_name))
